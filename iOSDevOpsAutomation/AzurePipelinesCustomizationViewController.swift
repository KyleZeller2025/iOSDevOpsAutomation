...
/// Purpose: Manages Azure Pipelines customization with form-based input.
/// Parameters: None
/// Returns: Void
/// Preconditions: None
/// Postconditions:
/// - Azure Pipelines configuration is customized based on user input
/// - Form validation ensures proper values
/// Throws: Never
/// Complexity: O(1)
/// Used By: PopupWindowController
class AzurePipelinesCustomizationViewController: BaseCustomizationViewController {
    ...
    private var vmImagePopUp: NSPopUpButton!
    
    // MARK: - Initialization
    
    /// Purpose: Initialize Azure Pipelines customization view with template.
    /// Parameters:
    ///   - template: The Azure Pipelines template to customize
    /// Returns: Void
    ...
    override func setupFormFields() {
        ...
        addPopUpButton(label: "VM Image:", popUp: &vmImagePopUp, options: [
            "macOS-13", "macOS-12", "macOS-11", "macOS-10.15"
        ])
    ...
    override func loadDefaultValues() {
        ...
        vmImagePopUp.selectItem(at: 0) // macOS-13
    ...
    override func generateCustomizedContent() -> String {
        ...
        pipeline = pipeline.replacingOccurrences(of: "__VM_IMAGE__", with: vmImagePopUp.titleOfSelectedItem ?? "macOS-13")
